...
const stageSolutions = {
  ...
  '1-10': ['mora', 'bibi', 'sora'],
  '2-1': ['serin', 'marin', 'nari'], '2-2': ['roa', 'yura', 'jigsaw'], '2-3': ['serin', 'lumi', 'nari'],
  '2-4': ['marin', 'jigsaw', 'bibi'], '2-5': ['yura', 'nari', 'neko'], '2-6': ['sora', 'bibi', 'mora'],
  '2-7': ['marin', 'serin', 'miku'], '2-8': ['noir', 'neko', 'marin'], '2-9': ['serin', 'jigsaw', 'miku'],
  '2-10': ['yura', 'sora', 'bibi'],
  '3-1': ['nari', 'roa', 'lumi'], '3-2': ['mora', 'jigsaw', 'bibi'], '3-3': ['lumi', 'bibi', 'sora'],
  '3-4': ['roa', 'jigsaw', 'nari'], '3-5': ['marin', 'neko', 'sora'], '3-6': ['roa', 'noir', 'nari'],
  '3-7': ['nari', 'yura', 'mora'], '3-8': ['sora', 'serin', 'neko'], '3-9': ['miku', 'roa', 'lumi'],
  ...
  '4-7': ['nari', 'noir', 'neko'], '4-8': ['yura', 'neko', 'noir'], '4-9': ['sora', 'serin', 'nari'],
  '4-10': ['noir', 'sora', 'roa'],
  '5-1': ['neko', 'yura', 'miku'], '5-2': ['lumi', 'serin', 'sora'], '5-3': ['roa', 'yura', 'bibi'],
  '5-4': ['nari', 'mora', 'jigsaw'], '5-5': ['bibi', 'sora', 'jigsaw'], '5-6': ['sora', 'serin', 'nari'],
